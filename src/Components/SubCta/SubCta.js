  ...
  return (
    <div className="">
      ...
      <div className="lg:mt-[70px] my-[30px] gap-y-4 lg:gap-0 lg:mb-[80px] flex md:flex-row flex-col md:justify-between ">
        <div className="pl-3 bg-[#282626] rounded-[50px] w-full lg:w-[50%] flex  justify-between items-center">
          <input
            type="search"
        ...
        <div className="max-w-[320px] text-white cta-text">
          ...
          <div className="flex justify-evenly gap-2 md:order-2 order-1">
            <div className="group">
              <img
                src={pint}
                alt=""
                className="block group-hover:hidden h-12 w-12 lg:h-16 lg:w-16"
              />
              <img
                src={pinthover}
                className=" group-hover:block hidden h-12 w-12 lg:h-16 lg:w-16"
                alt=""
              />
            </div>
            <div className="group">
