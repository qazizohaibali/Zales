            ...
            return (
              <div className="relative">
                ...
                <div className="absolute top-[150px] lg:top-[170px] lg:pl-[80px]">
                  ...
                  <div className="flex flex-col mx-3 lg:flex-row gap-4 mt-[40px] lg:mt-[60px] max-w-[150px] lg:max-w-full">
                    <Button
                      title="Order Now"
                      variant="secondary"
                  ...
                  <div className="flex flex-col progress-bar justify-between items-end h-[220px] -mr-[75px] md:-mr-[450px] lg:-mr-[470px] -mt-[340px] ">
                    <p className="text-white mr-[70px] ">01</p>
                    <progress
                      className="rotate-90"
                      max="100"
                      value={barValue}
                    ></progress>
                    <p className="text-white mr-[70px]">{`0${index + 1}`}</p>
                  </div>
                </div>
              </div>
            );
